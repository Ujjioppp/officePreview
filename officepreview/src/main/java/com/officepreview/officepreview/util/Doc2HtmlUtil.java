package com.officepreview.officepreview.util;
...
public class Doc2HtmlUtil {
    ...
    public static void main(String[] args) throws IOException {
        ...
        file = new File("E:/simple.xlsx");
        fileInputStream = new FileInputStream(file);
      coc2HtmlUtil.file2Html(fileInputStream, "E:","xls");
//        coc2HtmlUtil.file2pdf(fileInputStream, "E:/","xls");

//        file = new File("E:/test2.doc");
//        fileInputStream = new FileInputStream(file);
////        coc2HtmlUtil.file2Html(fileInputStream, "E:","doc");
//        coc2HtmlUtil.file2pdf(fileInputStream, "E:","doc");
//
